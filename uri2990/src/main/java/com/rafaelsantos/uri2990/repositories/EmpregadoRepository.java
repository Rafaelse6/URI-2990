...
import com.rafaelsantos.uri2990.dto.EmpregadoDeptDTO;
...
public interface EmpregadoRepository extends JpaRepository<Empregado, Long>{
	...
	@Query("SELECT new com.rafaelsantos.uri2990.dto.EmpregadoDeptDTO(obj.cpf, obj.enome, obj.departamento.dnome) "
			+ "FROM Empregado obj "
